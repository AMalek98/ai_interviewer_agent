...
from .models import OralEvaluationReport
from .response_evaluator import evaluate_all_oral_responses
...
def evaluate_oral_interview(interview_json_path: str) -> OralEvaluationReport:
    ...
    # Use new data structure: data/evaluation_reports/oral/
    report_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "data", "evaluation_reports", "oral")
...
if __name__ == "__main__":
    interview_path = r"C:\Users\Mega-PC\Desktop\ai_interviewer\backend\data\interviews\oral\oral-MALEK-AJMI-2025-10-07-111358.json"
